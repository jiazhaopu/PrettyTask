...
public class FixedRegisterAspect implements ILogger {
  ...
  public void afterThrowing(JoinPoint point, Throwable ex) throws Exception {
    ...
    FixedRegister
        register =
        AnnotationUtils.getAnnotation(method, FixedRegister.class);
    if (register == null) {
      return;
    }
  ...
  private void catchAfterThrowing(JoinPoint point,
      FixedRegister register, Throwable e) throws Exception {
    if (e == null) {
      return;
    }
  ...
  private void register(JoinPoint point, FixedRegister register)
      throws Exception {
